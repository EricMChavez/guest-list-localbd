//some sample data
const guestData = [ { email: 'asiemer@hotmail.com', firstname: 'Andy', lastname: 'Siemer', notes: 'hey there' } ];
...
function remove() {
	...
	var request = db.transaction([ 'guest' ], 'readwrite').objectStore('guest').delete(delid);
